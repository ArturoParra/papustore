        ...
        <div className="w-10/12 mx-auto m-12 bg-orange-100 rounded-md">
            ...
            <div className="flex flex-col w-full p-4 md:flex-row">
                ...
                <div className="flex flex-col ml-1 items-center md:w-1/2 md:gap-2 md:justify-center">
                    ...
                    <div className="text-white bg-sky-400 rounded-xl font-semibold text-[9px] p-1 md:text-xl">
                        Ahorra $200.00
                    </div>

                    <div className="mt-2 text-center font-semibold text-sm md:text-xl">
                        Macbook Pro
                    </div>

                    <div className="mt-2 text-xs text-center md:text-xl">
                        Repleto de innovación, el HomePod mini ofrece resultados inesperados.
                    </div>

                    <button className="flex bg-orange-400 text-white justify-center rounded-xl font-bold uppercase p-1.5 mt-2 text-[10px] md:text-xl">

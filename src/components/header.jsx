...
export function Header() {
    ...
    const iconoFlecha = <FontAwesomeIcon className=" text-black text-lg pl-2 pb-0.5" icon={fas.faSortDown} />;
    ...
    <header className="flex justify-center items-center px-16 py-5 w-full bg-zinc-900 max-md:px-5 max-md:max-w-ful">
      <div className="flex gap-5 justify-between w-full max-w-[1320px] max-md:flex-wrap max-md:max-w-full">
        ...
        <div className="relative">
            ...
            <div className="spinner-text">{categoriaSeleccionada}{iconoFlecha}</div>
            ...
            {mostrarCategorias && (
                ...
                {categorias.map((categoria, index) => (
                    <div
                    key={index}
                    className="px-4 py-0.5 hover:bg-yellow-200 hover:font-bold cursor-pointer"
